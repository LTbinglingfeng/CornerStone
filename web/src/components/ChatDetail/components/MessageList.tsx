        ...
        displayItems.map(item => {
          ...
          if (isRedPacketReceivedBanner) {
            return (
              <div key={item.key} className="message-item pat-banner-item">
                <RedPacketReceivedBanner toolCall={item.toolCall} messages={messages} userInfo={userInfo} prompt={prompt} />
              </div>
            )
          }
          ...
          const content = isRedPacket ? (
            (() => {
              ...
              const senderName = role === 'user' ? userDisplayName || '我' : assistantDisplayName || 'AI Assistant'
              ...
              return (
                <RedPacketBubble
                  ...
                  onClick={params => {
                    onOpenRedPacket(
                      { params, packetKey, senderRole: role, senderName, senderAvatarSrc: senderAvatarSrc || null },
                      initialStep
                    )
                  }}
                />
