        ...
        <div className="attachment-expand-panel" ref={panelRef} role="menu">
            <div className="attachment-grid">
                ...
                >
                    ...
                    <div className="attachment-tile-label">{t('chat.album')}</div>
                </button>
                ...
                >
                    ...
                    <div className="attachment-tile-label">{t('chat.redPacket')}</div>
                </button>
            </div>
        </div>
    )
