      ...
      <div className="auth-card">
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          <div className="auth-field">
            <label className="auth-label" htmlFor="auth-setup-username">用户名</label>
            <input
          ...
          <div className="auth-field">
            <label className="auth-label" htmlFor="auth-setup-password">密码</label>
            <input
          ...
          <div className="auth-field">
            <label className="auth-label" htmlFor="auth-setup-confirm">确认密码</label>
            <input
